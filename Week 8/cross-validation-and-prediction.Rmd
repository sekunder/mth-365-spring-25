...
knitr::include_graphics("../Week 7/images/model-fit.png")
```
...
```{r}
simple = lm(arr_delay ~ hour + dep_delay + hour:dep_delay, 
         data = TRAIN)
```
...
knitr::include_graphics("../Week 7/images/k-fold-cv1.png")
```
...
```{r echo=FALSE, fig.align='center', out.width="80%"}
knitr::include_graphics("../Week 7/images/k-fold-cv2.png")
```
...
knitr::include_graphics("../Week 7/images/extrapolation.png")
```
