...
i1 <- img_modal(src = "./images/comp-graphs.PNG", alt = "")
...
i3 <- img_modal(src = "./images/bad-gas.PNG", alt = "")
...
i4 <- img_modal(src = "./images/bad-bar.PNG", alt = "")
...
i1 <- img_modal(src = "./images/election-state.PNG", alt = "")
i3 <- img_modal(src = "./images/election-pop.PNG", alt = "")
...
i2 <- img_modal(src = "./images/electoral.PNG", alt = "")
...
i1 <- img_modal(src = "./images/mean-interval.PNG", alt = "")
...
i3 <- img_modal(src = "./images/hurricane.PNG", alt = "")
...
```{r, echo = FALSE, fig.align='center'}
knitr::include_graphics("../Week 5/images/with-caption.png")
```
---
## Captions
