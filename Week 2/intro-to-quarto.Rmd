...
knitr::include_graphics("../Week 2/images/render-process.png")
```
...
```{r, echo=FALSE, out.height="65%", out.width="90%", fig.align='center'}
knitr::include_graphics("../Week 2/images/quarto.jpg")
```
...
```{r, echo=FALSE, out.height="65%", out.width="90%", fig.align='center'}
knitr::include_graphics("../Week 2/images/quarto-document.png")
```
...
knitr::include_graphics("../Week 2/images/quarto-run.png")
```
...
```{r, echo=FALSE, fig.align='center'}
knitr::include_graphics("../Week 2/images/visual-editor.png")
```
