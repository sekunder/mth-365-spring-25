...
Let's try to extract the Creighton course catalog into a tidy format! In this file I will try to document the _process_ I used to get the table I'm after, since there's definitely a few hiccups along the way!
