...
**Functions** are sets of instructions that take input **arguments**, do some calculation, and **return** output values
...
Method 2 (recommended when you're starting out):
