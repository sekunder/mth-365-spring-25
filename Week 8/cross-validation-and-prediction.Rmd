...
knitr::include_graphics("../Week 8/images/bias-variance.png")
```
...
knitr::include_graphics("../Week 8/images/model-fit.png")
```
...
knitr::include_graphics("../Week 8/images/k-fold-cv1.png")
```
...
```{r echo=FALSE, fig.align='center', out.width="80%"}
knitr::include_graphics("../Week 8/images/k-fold-cv2.png")
```
...
knitr::include_graphics("../Week 8/images/extrapolation.png")
```
