...
knitr::include_graphics("../Week 1/images/rstudio.png")
...
knitr::include_graphics("../Week 1/images/editor.jpeg")
...
knitr::include_graphics("../Week 1/images/console.jpeg")
...
knitr::include_graphics("../Week 1/images/environment.jpeg")
...
i1 <- img_modal(src = "../Week 1/images/files.png", alt = "Files",other=list(width="30%"))
i2 <- img_modal(src = "../Week 1/images/packages.png", alt = "Packages",other=list(width="30%"))
i3 <- img_modal(src = "../Week 1/images/help.png", alt = "Help",other=list(width="30%"))
...
```{r, echo=FALSE}
data = read.csv("../Week 1/data/movie-2018.csv")
```
...
knitr::include_graphics("../Week 1/images/debug.png")
